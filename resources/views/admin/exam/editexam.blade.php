...
@section('title')
    Edit Exam || School Management system
@endsection
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div class="page-heading my-4">
                <h1 class="page-titles">Edit Exam</h1>
                <ol class="breadcrumb">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('updateexam',['id'=>$exam->id])}}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-header bg-dark">
                                <h2 class="text-center text-light">Edit Exam</h2>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <input type="submit" value="Update Exam" class="btn btn-outline-success">
                                    </div>
                                </div>
                            </div>
                        </div>
