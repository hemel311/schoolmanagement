...
@section('title')
    Add Accountant || School Management system
@endsection
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('createaccountant')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-header bg-dark">
                                <h2 class="text-center text-light">Add Accountant</h2>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <input type="submit" value="Add Accountant" class="btn btn-outline-success">
                                    </div>
                                </div>
                            </div>
                        </div>
