    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="page-heading my-4">
                <h1 class="page-titles">Add Package</h1>
                <ol class="breadcrumb">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('createfees') }}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="card">
                            <div class="card-header bg-dark">
                                <h2 class="text-center text-light">Add Package</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="fee_head_id" class="form-control">
                                            <option value="" selected>Select a Fee</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8 offset-md-3">
                                        <input type="submit" value="Add Fee" class="btn btn-outline-success">
                                    </div>
                                </div>
